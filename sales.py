...
tab1, tab2 = st.tabs(["XGBoostRegressor","over view"])
with tab1:
...
#	Store	Dept	Temperature	Fuel_Price	MarkDown1	MarkDown2	MarkDown3	MarkDown4	MarkDown5	CPI	Unemployment	Size	month_date	day_date	year_date	Type_B	Type_C	IsHoliday_True
        ...
        if submit_button and flag==0:
            ...
            import pickle 
            with open(r"c:\Users\dinee\Downloads\model.pkl", 'rb') as file:
                loaded_model = pickle.load(file)
            with open(r'c:\Users\dinee\Downloads\scaler.pkl', 'rb') as f:
...
# Introduction
st.markdown("""
This Streamlit app is designed to analyze and predict weekly sales based on historical data. The project involves the following key components:
""")
...
st.subheader("1. Data Loading and Joining")
st.markdown("""
- Load three datasets: sales, features, and stores.
- Join datasets based on common columns to create a consolidated dataframe (`df`).
""")

# 2. Exploratory Data Analysis (EDA)
st.subheader("2. Exploratory Data Analysis (EDA)")
st.markdown("""
- Visualize and understand the dataset through Seaborn and Matplotlib.
- Explore store types, size distribution, weekly sales based on store type, and the impact of holidays on sales.
...
st.markdown("""
- Handle NULL values by filling them with zeros.
- Extract date-related features (year, month, day).
- Apply one-hot encoding to categorical variables (`Type` and `IsHoliday`).
- Standardize numerical features using Standard Scaler.
""")

# ... Add sections for other key components

# Project Summary
st.header("Project Summary")
st.markdown("""
The project leverages machine learning models to predict weekly sales based on historical data and various features. 
Evaluation metrics provide insights into the performance of different regression models. 
The XGBoost model, known for its predictive power, is chosen and saved for deployment or future use.
""")

# Possible Future Steps
st.header("Possible Future Steps")
st.markdown("""
- Further tuning of hyperparameters to enhance model performance.
- Integration of the model into a production environment for real-time predictions.
- Continuous monitoring and retraining to adapt to changing patterns in the data.
""")

# Considerations for Project Evaluation
st.header("Considerations for Project Evaluation")
st.markdown("""
- Clear understanding of the dataset, business problem, and problem-solving approach.
- Rigorous evaluation of model performance using appropriate metrics.
- Effective communication of insights gained from exploratory analysis.
- Documentation and organization of code for clarity and reproducibility.
""")

# Conclusion
st.header("Conclusion")
st.markdown("""
This project demonstrates the application of machine learning techniques to predict weekly sales, providing a foundation for decision-making and resource optimization in retail scenarios.
The use of various regression models and thorough evaluation contributes to the robustness of the predictive system.
""")
...
#import streamlit as st
    ...
    #st.image(image_url, caption="Your Image Caption", use_column_width=True)
     #"C:\Users\dinee\.vscode\WhatsApp Image 2024-01-24 at 09.52.52_9cefa05d.jpg"
#with tab3:
